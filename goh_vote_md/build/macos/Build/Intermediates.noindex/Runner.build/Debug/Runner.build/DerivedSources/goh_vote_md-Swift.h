...
#ifndef GOH_VOTE_MD_SWIFT_H
#define GOH_VOTE_MD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="goh_vote_md",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11goh_vote_md11AppDelegate")
...
SWIFT_CLASS("_TtC11goh_vote_md17MainFlutterWindow")
